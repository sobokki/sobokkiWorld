    ...
    <div className={styles.modalContainerWrapper}>
      <ModalContainer closeClick={closeClick} className={styles.modalContainer}>
        ...
        <section>
          ...
          <div className={styles.explanation}>
            <Link href="https://taskify-team3.vercel.app/" target="_blank">
              https://taskify-team3.vercel.app/
            </Link>
          </div>
        </section>
        ...
        <section>
          ...
          <div className={styles.explanation}>
            <Link
              href="https://github.com/1cheol-and-team3-taskify/taskify"
              target="_blank"
            >
              https://github.com/1cheol-and-team3-taskify/taskify
            </Link>
          </div>
        </section>
      </ModalContainer>
